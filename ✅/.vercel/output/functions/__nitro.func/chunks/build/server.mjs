...
const router_nyHnpG4Kcu7grL1XzG3WOz1uk6bhVbqQBCR60aAjprg = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const plugins = [
  ...
  router_nyHnpG4Kcu7grL1XzG3WOz1uk6bhVbqQBCR60aAjprg,
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7c414115"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BaWV2nm9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B9nFNZku.mjs'));
