...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div style="${ssrRenderStyle({ "padding": "2rem" })}"><h1>Nuxt 4 funcionando desde Docker 🎉</h1></div></div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cua35mNi.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DKNn5NtP.mjs'));
