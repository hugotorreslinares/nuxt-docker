...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "84bb0f2a-26f2-4e54-8c98-73f9004de22e",
...
const _lazy_UvA4eZ = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UvA4eZ, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UvA4eZ, lazy: true, middleware: false, method: undefined }
];
